...
export const MotorChannelInformationForm = ({ handleFormData }: any) => {
...
export const MotorMachineDetailsForm = ({ handleFormData }: any) => {
  return (
    <>
      <Grid
        container
...
export const MotorDiagnosticDetails = ({ handleFormData }: any) => {
  return (
    <>
      <Grid
        container
